    <div class="max-w-screen-xl mx-auto bg-white rounded shadow-lg p-4">
        <h1 class="text-2xl font-semibold mb-4">Solicitudes de Titulación aceptadas</h1>
        <div>
           ...
           @foreach ($solicitudes as $index =>$i)
            <li class="p-4 border border-gray-300 rounded">
                ...
                <div class="mt-2 flex justify-end">
                    ...
                    @endif
                    <button wire:click.prevent="informacion('{{ $i->id_solicitud }}')" class="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600">Configurar</button>
                </div>
            </li>
            @endforeach
        </ul>
